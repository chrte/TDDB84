...
public class Room extends MapSite { 
	...
	/**
	 * Called when a moving object wants to enter the room and it places the movingobject in the room.
	...
	public void paint(Graphics g) {		
        g.drawImage(Images.instance().getRoomImage(roomSize), offsetX, offsetY, null);
	...
	/**
	 * Moves the room.
	 * @param x New room x coordinate.
	 * @param y New room y coordinate.
	 */
	...
	/**
	 * Sets a side of the room. If there already is a side in this direction it is replaced.
	...
	/**
	 * Gets the x coordinate of the graphical offset. Is used when eg drawing a Person inside the room
	 * @return X offset
	 */
	...
	/**
	 * Decides wiether or not this is the correct room which means that the room is placed at the x and y coordinates. 
	 * @param x The searched rooms x coordinate. 
	 * @param y The searched rooms x coordinate.
