...
/**
 * A Singleton Factory that creates and stores images and is used as an image repository that only has a single copy of every image loaded.
...
public class Images {
	...
	/**
	 * Gets an instance of the images. If no instance exists it create one using an StableApplet in the constructor.
	...
	/**
	 * Sets the applet and MUST be called before the images is used for the first time.
	 * @param a The applet.
	 */
...
//			String fullImagePath = "/home/" + System.getProperty("user.name") + "/" + imagePath + imageName;;
	 ...
	 * @param width Wallwidth.
	 * @param height Wallheight.
	 * @return WallImage.
	 */
	 ...
	 * @param width Doorwidth.
	 * @param height Doorheight.
	 * @param open If it is true then an image of an open door is returned otherwise an image of a closed door i returned
	 * @return DoorImage.
	 */
	 ...
	 * @param width Boxdoorwidth.
	 * @param height Boxdoorheight.
	 * @param open If it is true then an image of an open boxdoor is returned otherwise an image of a closed boxdoor i returned
	 * @return BoxdoorImage.
	 */
